...
function Inicio() {
  ...
  // Recuperando usuario para poder evaluar el  inicio de sesion
  ...
  return (
    <div className="background">
      ...
      <form onSubmit={handleInicio}>
        ...
        <button className="botonI" onClick={handleInicio}>
          Log In
        </button>
        <button className="botonI" onClick={handleRegistrarClick}>
          Registrar
        </button>
      </form>
    </div>
